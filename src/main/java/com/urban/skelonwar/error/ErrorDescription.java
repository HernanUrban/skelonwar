...
public class ErrorDescription {
     ...
     */
    public static ErrorDescription buildError(int code, String module, Throwable throwable, HttpServletRequest request) {
     ...
     * @return an ErrorDescription.
     */
    public static ErrorDescription buildError(String module, SkelonwarError error, HttpServletRequest request) {
     ...
     */
    private static ErrorDescription requestInformation(ErrorDescription description, HttpServletRequest request) {
        if (request != null) {
    ...
    private static String buildStringTrace(StackTraceElement[] elements) {
        if (elements != null && elements.length > 0) {
            ...
            for (int t = 0; t < length && t < MAX_STACK_LINES; t++) {
                builder.append(String.format("%s:%s:%s(%s) ", elements[t].getClassName(), elements[t].getMethodName(),
